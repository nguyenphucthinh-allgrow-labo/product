...
$config['licenseName'] = 'takamart.vn';
$config['licenseKey']  = '6A7AKNRC6EFFR7D5QQLJUWKVGV6RB';
...
$config['backends']['default'] = array(
    'name'         => 'default',
    'adapter'      => 'local',
	'baseUrl'      => env('RESOURCE_URL_PATH') . '/public/userfiles' . '/',
	'root'         => env('RESOURCE_PHYSICAL_PATH') . '/public/userfiles' . '/',
	'chmodFiles'   => 0755,
    'chmodFolders' => 0755,
